...
Numbered references for [prompt-engineering-taxonomy-compact.md](./prompt-engineering-taxonomy-compact.md) and [prompt-engineering-taxonomy.md](./prompt-engineering-taxonomy.md). All sources are within the 8-month recency window (June 2025 – February 2026) or are evergreen documentation kept current by their maintainers.
...
24. OpenAI (Sep 2025). "Why Language Models Hallucinate." Research page. [openai.com](https://openai.com/research/why-language-models-hallucinate)
